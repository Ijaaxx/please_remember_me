...
init -501 screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Past") action ShowMenu("history")
        ...
        if renpy.variant("pc"):
            ...
            textbutton _("Goodbye") action Quit(confirm=not main_menu)
...
init -501 screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Page {}"), auto=_("From me"), quick=_("From you"))
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Skip")
                    textbutton _("Unseen Conversation") action Preference("skip", "toggle")
                    textbutton _("After Responses") action Preference("after choices", "toggle")
...
init -501 screen history():
    ...
    use game_menu(_("Past"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
...
init -501 screen help():
    ...
    use game_menu(_("Help me"), scroll="viewport"):
...
init -501 screen keyboard_help():
    ...
    hbox:
        label _("Space")
        text _("Advances dialogue without selecting choices. Why? You don't want to talk to me?")
    ...
    hbox:
        label _("Ctrl")
        text _("Skips dialogue while held down. Don't.")

    hbox:
        label _("Tab")
        text _("Toggles dialogue skipping. Though I'd prefer you not.")

    hbox:
        label _("Page Up")
        text _("Rolls back to earlier dialogue. In case you missed me.")
    ...
    hbox:
        label "S"
        text _("Takes a screenshot. Take nice ones. I'm sooo cute.")
...
init -501 screen confirm(message, yes_action, no_action):
    ...
    frame:
        ...
        label _("Are you sure you want to quit? Please don't."):
        ...
        hbox:
            ...
            textbutton _("I'm sorry") action no_action
